...
# datasets select
	...
	for db_raw in "${selected_dbs[@]}"; do
		...
		case "$db" in
			...
			PANTHER_PATH|PANTHERPATH|PANTHER_PATHWAY|PANTHER_PATHWAYS|PANTHERPATHWAY|PANTHERPATHWAYS) datasets+=("ANNOT_TYPE_ID_PANTHER_PATHWAY") ;;
			GO|GOS|GENE_ONTOLOGY|GENE_ONTOLOGYS) datasets+=("GO:0005575" "GO:0008150" "GO:0003674") ;;
